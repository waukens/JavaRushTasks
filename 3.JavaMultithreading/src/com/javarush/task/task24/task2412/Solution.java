                ...
                if (nameCompare != 0) {
                    ...
                    if (dateCompare != 0) {
                        ...
                        if (stock1.containsKey("change")) {
                            changeStock1 = (double)stock1.get("change");
                        } else {
                            changeStock1 = (double)stock1.get("last") -
                                    (double)stock1.get("open");
                        }
                        if (stock2.containsKey("change")) {
                            changeStock2 = (double)stock2.get("change");
                        } else {
                            changeStock2 = (double)stock2.get("last") -
                                    (double)stock2.get("open");
                        }
                        return Double.compare(changeStock2, changeStock1);
